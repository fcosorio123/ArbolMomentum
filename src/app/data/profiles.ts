...
const YESA_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    {
      id: 'y-climb-mon', label: 'Bouldering Training', icon: '🧗', color: '#A72D1A', goalId: 'yesa-bouldering-podium',
      tasks: [
    ...
    {
      id: 'y-school-mon', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'yesa-stable-job',
      tasks: [
  ...
  Tue: [
    {
      id: 'y-social-tue', label: 'Social & Rest', icon: '🤝', color: '#8E1533', goalId: 'yesa-healthy-lifestyle',
      tasks: [
    ...
    {
      id: 'y-school-tue', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'yesa-stable-job',
      tasks: [
  ...
  Wed: [
    {
      id: 'y-climb-wed', label: 'Bouldering - Projecting', icon: '🧗', color: '#A72D1A', goalId: 'yesa-bouldering-podium',
      tasks: [
    ...
    {
      id: 'y-school-wed', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'yesa-stable-job',
      tasks: [
  ...
  Thu: [
    ...
    {
      id: 'y-school-thu', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'yesa-stable-job',
      tasks: [
  ...
  Fri: [
    {
      id: 'y-climb-fri', label: 'Bouldering - Technique', icon: '🧗', color: '#A72D1A', goalId: 'yesa-bouldering-podium',
      tasks: [
    ...
    {
      id: 'y-school-fri', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'yesa-stable-job',
      tasks: [
  ...
  Sat: [
    {
      id: 'y-climb-sat', label: 'Boulder Gym / Outdoor', icon: '🧗', color: '#A72D1A', goalId: 'yesa-bouldering-podium',
      tasks: [
...
const KYLE_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    {
      id: 'k-education-mon', label: 'Education', icon: '📚', color: '#8E1533', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-mon', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Tue: [
    {
      id: 'k-education-tue', label: 'Education', icon: '📚', color: '#8E1533', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-tue', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Wed: [
    {
      id: 'k-education-wed', label: 'Education', icon: '📚', color: '#8E1533', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-wed', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Thu: [
    {
      id: 'k-education-thu', label: 'Education', icon: '📚', color: '#8E1533', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-thu', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Fri: [
    {
      id: 'k-education-fri', label: 'Education', icon: '📚', color: '#8E1533', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-fri', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Sat: [
    {
      id: 'k-mock-sat', label: 'Exam Readiness', icon: '📝', color: '#A72D1A', goalId: 'kyle-graduation',
      tasks: [
    ...
    {
      id: 'k-finance-sat', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
  ...
  Sun: [
    ...
    {
      id: 'k-finance-sun', label: 'Finance', icon: '💰', color: '#A72D1A', goalId: 'kyle-birthday-savings',
      tasks: [
...
const JUDE_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    ...
    {
      id: 'j-fitness-mon', label: 'Fitness & Health', icon: '🏋️', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-mon', label: 'Daily Reset', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Tue: [
    ...
    {
      id: 'j-fitness-tue', label: 'Fitness & Health', icon: '🏋️', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-tue', label: 'Daily Reset', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Wed: [
    ...
    {
      id: 'j-fitness-wed', label: 'Fitness & Health', icon: '🏋️', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-wed', label: 'Daily Reset', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Thu: [
    ...
    {
      id: 'j-fitness-thu', label: 'Fitness & Health', icon: '🏋️', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-thu', label: 'Daily Reset', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Fri: [
    ...
    {
      id: 'j-fitness-fri', label: 'Fitness & Health', icon: '🏋️', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-fri', label: 'Daily Reset', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Sat: [
    ...
    {
      id: 'j-weekend-sat', label: 'Finance', icon: '🏠', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
    ...
    {
      id: 'j-evening-sat', label: 'Healthy Living', icon: '🌙', color: '#A72D1A',
      goalId: 'jude-travel-fund',
      tasks: [
  ...
  Sun: [
    ...
    {
      id: 'j-evening-sun', label: 'Healthy Living', icon: '🌙', color: '#8E1533',
      goalId: 'jude-travel-fund',
      tasks: [
...
const RAFAEL_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    {
      id: 'r-school-mon', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Tue: [
    {
      id: 'r-school-tue', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Wed: [
    {
      id: 'r-school-wed', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Thu: [
    {
      id: 'r-school-thu', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Fri: [
    {
      id: 'r-school-fri', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Sat: [
    {
      id: 'r-school-sat', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
  ...
  Sun: [
    {
      id: 'r-work-sun', label: 'Income & Savings', icon: '💼', color: '#A72D1A', goalId: 'rafael-emergency-fund',
      tasks: [
        { id: 'rafael-sun-1', label: 'Work', timeOfDay: 'morning', type: 'priority', category: 'r-work-sun' },
      ],
    },
    {
      id: 'r-school-sun', label: 'Academics', icon: '📚', color: '#8E1533', goalId: 'rafael-academic',
      tasks: [
...
const FAVIO_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    {
      id: 'fav-hl-mon', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-mon', label: 'Fitness & Strength', icon: '🏋️', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Tue: [
    {
      id: 'fav-hl-tue', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-tue', label: 'Fitness & Cardio', icon: '🏃', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Wed: [
    {
      id: 'fav-hl-wed', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-wed', label: 'Recovery & Mobility', icon: '🤸', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Thu: [
    {
      id: 'fav-hl-thu', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-thu', label: 'Fitness & Strength', icon: '🏋️', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Fri: [
    {
      id: 'fav-hl-fri', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-fri', label: 'Fitness & Cardio', icon: '🏃', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Sat: [
    {
      id: 'fav-hl-sat', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-sat', label: 'Fitness & Tennis', icon: '🎾', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
  ...
  Sun: [
    {
      id: 'fav-hl-sun', label: 'Healthy Living', icon: '🥗', color: '#A72D1A', goalId: 'favio-lose-weight',
      tasks: [
    ...
    {
      id: 'fav-fit-sun', label: 'Fitness & Reset', icon: '🚶', color: '#8E1533', goalId: 'favio-longevity',
      tasks: [
...
const ROI_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    ...
    {
      id: 'roi-walk-mon', label: 'Daily Walk', icon: '🚶', color: '#8E1533', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Tue: [
    {
      id: 'roi-hip-tue', label: 'Hip Mobility', icon: '🤸', color: '#A72D1A', goalId: 'roi-healthy-mind-body',
      tasks: [
    ...
    {
      id: 'roi-bw-tue', label: 'Body Weight Workout', icon: '💪', color: '#8E1533', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Wed: [
    {
      id: 'roi-leg-wed', label: 'Leg Day', icon: '🦵', color: '#A72D1A', goalId: 'roi-healthy-mind-body',
      tasks: [
    ...
    {
      id: 'roi-walk-wed', label: 'Daily Walk', icon: '🚶', color: '#8E1533', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Thu: [
    ...
    {
      id: 'roi-bw-thu', label: 'Body Weight Workout', icon: '💪', color: '#8E1533', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Fri: [
    {
      id: 'roi-hip-fri', label: 'Hip Mobility', icon: '🤸', color: '#A72D1A', goalId: 'roi-healthy-mind-body',
      tasks: [
    ...
    {
      id: 'roi-walk-fri', label: 'Daily Walk', icon: '🚶', color: '#8E1533', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Sat: [
    {
      id: 'roi-cycling-sat', label: 'Cycling Session', icon: '🚴', color: '#A72D1A', goalId: 'roi-healthy-mind-body',
      tasks: [
  ...
  Sun: [
    {
      id: 'roi-leg-sun', label: 'Leg Day', icon: '🦵', color: '#A72D1A', goalId: 'roi-healthy-mind-body',
      tasks: [
...
const EUNICE_BY_DAY: Record<string, TaskCategory[]> = {
  Mon: [
    ...
    {
      id: 'eu-evening-mon', label: 'Evening Routine', icon: '🌙', color: '#8E1533', goalId: 'eunice-artwork',
      tasks: [
  ...
  Tue: [
    ...
    {
      id: 'eu-paint-tue', label: 'Art & Creativity', icon: '🎨', color: '#A72D1A', goalId: 'eunice-artwork',
      tasks: [
        { id: 'eu-tue-5', label: 'Painting session - at least 30 min', timeOfDay: 'morning', type: 'goal', category: 'eu-paint-tue' },
      ],
    },
    {
      id: 'eu-evening-tue', label: 'Evening Routine', icon: '🌙', color: '#8E1533',
      tasks: [
  ...
  Wed: [
    ...
    {
      id: 'eu-evening-wed', label: 'Evening Routine', icon: '🌙', color: '#8E1533', goalId: 'eunice-artwork',
      tasks: [
  ...
  Thu: [
    ...
    {
      id: 'eu-paint-thu', label: 'Art & Creativity', icon: '🎨', color: '#A72D1A', goalId: 'eunice-artwork',
      tasks: [
    ...
    {
      id: 'eu-evening-thu', label: 'Evening Routine', icon: '🌙', color: '#8E1533',
      tasks: [
  ...
  Fri: [
    ...
    {
      id: 'eu-evening-fri', label: 'Evening Routine', icon: '🌙', color: '#8E1533',
      tasks: [
  ...
  Sat: [
    ...
    {
      id: 'eu-paint-sat', label: 'Art & Creativity', icon: '🎨', color: '#A72D1A', goalId: 'eunice-artwork',
      tasks: [
    ...
    {
      id: 'eu-evening-sat', label: 'Evening Wind-down', icon: '🌙', color: '#8E1533',
      tasks: [
  ...
  Sun: [
    ...
    {
      id: 'eu-paint-sun', label: 'Art & Creativity', icon: '🎨', color: '#A72D1A', goalId: 'eunice-artwork',
      tasks: [
    ...
    {
      id: 'eu-planning-sun', label: 'Weekly Planning', icon: '📋', color: '#8E1533',
      tasks: [
